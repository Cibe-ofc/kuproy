...
global.merchant = 'M220614ZUXJ9113QA'
global.secret = 'd90df7928883f9d5193460ca07e62682078377dfd80fdea60239491df93a45f0'
global.signature = 'ed64d269f05fec7f946af054efd7829a'
//CARA AKTIFIN:
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case prefix+'donasi': case prefix+'donate': case prefix+'sewabot': case prefix+'sewa': case prefix+'buypremium': case prefix+'jadibot':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                reply(` LIST!\n\nHi ${pushname} \n\`\`\`GOPAY : CHAT OWNER\`\`\`\n\`\`\`DANA : CHAT OWNER\`\`\`\n\`\`\`PULSA : TANYA OWNER\`\`\`\nUntuk list harga silahkan chat🎳: wa.me//6287873670287 _^\n THX FOR YOU ! `)
            }
            break
...
———————————————————
Note: Owner Tidak Bertanggung Jawab Jika Ada Masalah Antara Pengguna Bot`, image: { url: "./media/anonymous.jpg" }, templateButtons: buttonsAnon, footer: 'ImanBot By Own-Iman√', mentions: [m.sender] })
			break
			}
